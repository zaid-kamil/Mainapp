...
public class GateinfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gateinfo);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        WebView htawebview = (WebView) findViewById(R.id.gateinfowebview);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.Bookmark:
                ...
                String name = bookmarks.getString("GateinfoActivity", "");
                if (name.isEmpty()) {
                    bookmarks.edit().putString("GateinfoActivity", "GateinfoActivity.class").apply();
                } else {
                    Toast.makeText(GateinfoActivity.this, "Already bookmarked", Toast.LENGTH_SHORT).show();
